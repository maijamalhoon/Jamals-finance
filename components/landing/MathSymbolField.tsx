...
const symbols: MathSymbol[] = [
  ...
  { glyph: "÷", tone: "divide", x: 41, size: 0.9, duration: 22, delay: -8, opacity: 0.27, driftA: -14, driftB: -4, driftC: 11, rotateStart: 9, rotateEnd: -14 },
  ...
  { glyph: "×", tone: "multiply", x: 90, size: 0.82, duration: 21, delay: -13, opacity: 0.27, driftA: -12, driftB: -19, driftC: -4, rotateStart: 8, rotateEnd: -16 },
  { glyph: "÷", tone: "divide", x: 96, size: 1.06, duration: 15, delay: -9, opacity: 0.24, driftA: -18, driftB: -7, driftC: -22, rotateStart: -6, rotateEnd: 10 },
