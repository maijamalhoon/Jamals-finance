...
export const mailIconDefinition = {
  ...
  accent: { x: 8.8, y: 15.6, width: 3.2, height: 0.42, rotation: 0 }, defaultAccent: "none",
...
export const chatIconDefinition = {
  ...
  accent: { x: 14.3, y: 13, width: 2.4, height: 0.38, rotation: 0 }, defaultAccent: "none",
} as const satisfies JalvoroIconDefinition;
...
export const phoneIconDefinition = {
  ...
  accent: { x: 10.6, y: 12, width: 2.8, height: 0.42, rotation: 45 }, defaultAccent: "none",
} as const satisfies JalvoroIconDefinition;
...
export const sendIconDefinition = {
  ...
  accent: { x: 9, y: 11.8, width: 2.6, height: 0.42, rotation: 0 }, defaultAccent: "none",
} as const satisfies JalvoroIconDefinition;
...
export const globeIconDefinition = {
  ...
  accent: { x: 10.6, y: 11.9, width: 2.8, height: 0.42, rotation: 0 }, defaultAccent: "none",
} as const satisfies JalvoroIconDefinition;
