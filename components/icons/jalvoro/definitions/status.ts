...
export const successIconDefinition = {
  ...
  accent: { x: 7.6, y: 17, width: 2.8, height: 0.38, rotation: 0 }, defaultAccent: "subtle",
...
export const warningIconDefinition = {
  ...
  accent: { x: 9.3, y: 7.2, width: 2.8, height: 0.38, rotation: 0 }, defaultAccent: "zigzag",
} as const satisfies JalvoroIconDefinition;
...
export const infoIconDefinition = {
  ...
  accent: { x: 7.3, y: 16.8, width: 2.6, height: 0.38, rotation: 0 }, defaultAccent: "wave",
} as const satisfies JalvoroIconDefinition;
...
export const errorIconDefinition = {
  ...
  accent: { x: 7.2, y: 17, width: 2.7, height: 0.38, rotation: 0 }, defaultAccent: "zigzag",
} as const satisfies JalvoroIconDefinition;
...
export const pendingIconDefinition = {
  ...
  accent: { x: 6.9, y: 15.8, width: 2.6, height: 0.38, rotation: 8 }, defaultAccent: "wave",
} as const satisfies JalvoroIconDefinition;
...
export const sparkIconDefinition = {
  ...
  accent: { x: 8.6, y: 18.1, width: 2.5, height: 0.38, rotation: 0 }, defaultAccent: "subtle",
} as const satisfies JalvoroIconDefinition;
