...
export const CATEGORY_ICON_CATALOG: readonly CategoryIconEntry[] = [
  ...
  { iconKey: "commission", label: "Commission", types: INCOME, keywords: ["commission", "brokerage", "affiliate", "referral"] },
  { iconKey: "bonus", label: "Bonus and reward", types: INCOME, keywords: ["bonus", "reward", "incentive", "cashback"] },
  { iconKey: "investment", label: "Investment return", types: INCOME, keywords: ["profit", "dividend", "investment", "shares", "return"] },
  ...
  { iconKey: "optical", label: "Dental and optical", types: EXPENSE, keywords: ["dental", "dentist", "eye", "glasses", "optical"] },
  { iconKey: "insurance", label: "Insurance and takaful", types: EXPENSE, keywords: ["insurance", "takaful", "protection"] },
  ...
  { iconKey: "beauty", label: "Salon and beauty", types: EXPENSE, keywords: ["salon", "barber", "haircut", "beauty", "makeup"] },
  ...
  { iconKey: "movies", label: "Movies and entertainment", types: EXPENSE, keywords: ["movie", "cinema", "film", "entertainment"] },
  { iconKey: "music", label: "Music and subscriptions", types: EXPENSE, keywords: ["music", "spotify", "netflix", "subscription", "membership"] },
  { iconKey: "laptop", label: "Computer and electronics", types: BOTH, keywords: ["computer", "laptop", "electronics", "printer", "camera"] },
  { iconKey: "cloud", label: "Software and cloud", types: BOTH, keywords: ["software", "app", "saas", "hosting", "domain", "cloud"] },
  { iconKey: "repair", label: "Repairs and maintenance", types: EXPENSE, keywords: ["repair", "maintenance", "mechanic", "service", "workshop"] },
  { iconKey: "construction", label: "Construction and labour", types: EXPENSE, keywords: ["construction", "renovation", "labour", "mistri", "hardware"] },
  ...
  { iconKey: "charity", label: "Charity and zakat", types: EXPENSE, keywords: ["charity", "donation", "zakat", "sadqa", "khairat"] },
  { iconKey: "tax", label: "Tax and fees", types: EXPENSE, keywords: ["tax", "fee", "charge", "accounting"] },
  { iconKey: "legal", label: "Legal and security", types: EXPENSE, keywords: ["legal", "lawyer", "court", "security", "guard"] },
  { iconKey: "receipt", label: "Bills and receipts", types: EXPENSE, keywords: ["bill", "receipt", "invoice", "expense"] },
  { iconKey: "help", label: "Help and assistance", types: EXPENSE, keywords: ["help", "assistance", "support", "emergency"] },
