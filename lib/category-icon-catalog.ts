...
export const CATEGORY_ICON_CATALOG: readonly CategoryIconEntry[] = [
  ...
  { iconKey: "investment", label: "Investment return", types: INCOME, keywords: ["profit", "dividend", "investment", "shares", "return"], group: "money" },
  ...
  { iconKey: "home", label: "Home and rent", types: EXPENSE, keywords: ["home", "rent", "mortgage", "house", "kiraya"], group: "home" },
  ...
  { iconKey: "receipt", label: "Bills and receipts", types: EXPENSE, keywords: ["bill", "receipt", "invoice", "expense"], group: "money" },
